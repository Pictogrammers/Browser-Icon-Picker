    ...
    >
        <header class="header">
            ...
            <div class="filter-wrap">
                ...
                />
                <i
                    class="filter-clear mdi mdi-close"
                    :class="{
        ...
        <div class="content">
            ...
            <transition name="properties">
                <div class="icon-properties" v-show="isIconActive">
                    <i
                        class="icon-icon"
                        :class="activeIcon && 'mdi mdi-'+activeIcon.name"
        ...
        <footer>
            <div class="left">
                <a
                    class="btn-sm-round"
                    :href="isIconActive
                        ? 'https://materialdesignicons.com/icon/{icon}'.replace('{icon}', activeIcon.name)
                        : 'https://materialdesignicons.com'"
                    target="_blank"
                    :title="isIconActive
                        ? 'Open {icon} in MaterialDesignIcons.com'.replace('{icon}', activeIcon.name)
                        : 'Open MaterialDesignIcons.com'
                    "
                >
    ...
    export default {
        ...
        methods: {
            ...
            downloadSvg() {
                ...
                const svg = this.svg[name].replace('<svg ', '<svg xmlns="http://www.w3.org/2000/svg" ');
